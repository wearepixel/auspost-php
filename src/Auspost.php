...
class Auspost
{
     ...
     *
     * @return \Joelwmale\Auspost\Address|false
     * @throws \Exception
     */
     ...
     * @return \Joelwmale\Auspost\Shipment
     */
     ...
     * @param bool $returnManifest
     *
     * @return Order
     */
    public function createOrder($shipment_ids, bool $callOrderSummary = true)
    {
        $request = [
            'shipments' => [],
        ];
